...
function EnglishContent() {
  return (
    <>
      ...
      <h2>1. Services</h2>
      <p>NovaWorks provides custom software development services, including but not limited to: AI &amp; machine learning solutions, web application development, mobile application development, and industrial automation &amp; IIoT (&quot;Services&quot;).</p>
      ...
      <p>Proposals provided by NovaWorks are valid for 30 (thirty) calendar days from the date of issuance, unless otherwise stated in the proposal.</p>
      ...
      <ul>
        ...
        <li>NovaWorks reserves the right to suspend work on a project if invoices remain unpaid for more than 30 (thirty) days beyond their due date.</li>
      </ul>
      ...
      <ul>
        ...
        <li>NovaWorks retains ownership of any pre-existing tools, libraries, frameworks, and general-purpose code (&quot;NovaWorks IP&quot;) used in the project. The Client is granted a non-exclusive, perpetual, royalty-free license to use NovaWorks IP as part of the delivered project.</li>
        <li>Third-party software and open-source components used in the project remain subject to their respective licenses.</li>
      </ul>
      <p>Until full payment is received, all intellectual property rights in the deliverables remain with NovaWorks.</p>
      ...
      <p>NovaWorks reserves the right to mention the Client&apos;s name and a general description of the project in its portfolio and marketing materials, unless the Client explicitly requests otherwise in writing.</p>
      ...
      <p>NovaWorks will communicate proactively about any anticipated delays and work with the Client to find reasonable solutions.</p>

      <h2>7. Change Requests</h2>
      <p>Any changes to the agreed scope of work must be requested in writing and acknowledged by NovaWorks. Changes may affect the project timeline and cost.</p>
      <p>NovaWorks will provide an estimate for the impact of the requested changes before proceeding. Work on change requests will only begin after written approval from the Client.</p>

      <h2>8. Warranties</h2>
      <p>NovaWorks warrants that:</p>
      <ul>
        ...
        <li>During the Warranty Period, NovaWorks will correct any defects or bugs at no additional cost, provided the issues are caused by NovaWorks&apos;s work and not by modifications made by the Client or third parties.</li>
      </ul>
      ...
      <ul>
        <li>NovaWorks&apos;s total liability under any Project Agreement shall not exceed the total amounts paid by the Client under that specific agreement.</li>
        <li>NovaWorks shall not be liable for any indirect, incidental, consequential, or special damages, including but not limited to: loss of profits, loss of data, business interruption, or loss of business opportunities.</li>
        <li>NovaWorks shall not be liable for damages arising from the Client&apos;s misuse of the deliverables, modifications made by third parties, or failure to maintain adequate backups.</li>
      </ul>
      ...
      <h2>15. Amendments</h2>
      <p>NovaWorks reserves the right to modify these Terms at any time. The updated version will be posted on our website with a revised &quot;Last updated&quot; date.</p>
...
function RomanianContent() {
  return (
    <>
      ...
      <h2>1. Servicii</h2>
      <p>NovaWorks furnizează servicii de dezvoltare software personalizat, inclusiv dar fără a se limita la: soluții AI și machine learning, dezvoltare aplicații web, dezvoltare aplicații mobile și consultanță tehnică (&quot;Servicii&quot;).</p>
      ...
      <p>Propunerile furnizate de NovaWorks sunt valabile 30 (treizeci) de zile calendaristice de la data emiterii, cu excepția cazului în care se prevede altfel în propunere.</p>
      ...
      <ul>
        ...
        <li>NovaWorks își rezervă dreptul de a suspenda lucrările la un proiect dacă facturile rămân neachitate mai mult de 30 (treizeci) de zile după data scadenței.</li>
      </ul>
      ...
      <p>NovaWorks își rezervă dreptul de a menționa numele Clientului și o descriere generală a proiectului în portofoliul și materialele de marketing, cu excepția cazului în care Clientul solicită explicit altfel în scris.</p>
      ...
      <p>NovaWorks va comunica proactiv despre orice întârzieri anticipate și va colabora cu Clientul pentru a găsi soluții rezonabile.</p>

      <h2>7. Solicitări de Modificare</h2>
      <p>Orice modificare a scopului convenit trebuie solicitată în scris și confirmată de NovaWorks. Modificările pot afecta termenul și costul proiectului.</p>
      <p>NovaWorks va furniza o estimare a impactului modificărilor solicitate înainte de a proceda. Lucrările la modificări vor începe doar după aprobarea scrisă a Clientului.</p>

      <h2>8. Garanții</h2>
      <p>NovaWorks garantează că:</p>
      <ul>
        ...
        <li>Pe durata Perioadei de Garanție, NovaWorks va corecta orice defecte sau erori fără costuri suplimentare, cu condiția ca problemele să fie cauzate de lucrarea NovaWorks și nu de modificări efectuate de Client sau terți.</li>
      </ul>
      ...
      <ul>
        ...
        <li>NovaWorks nu va fi răspunzătoare pentru daune indirecte, incidentale, consecutive sau speciale, inclusiv dar fără a se limita la: pierderi de profit, pierderi de date, întreruperea activității sau pierderea oportunităților de afaceri.</li>
        <li>NovaWorks nu va fi răspunzătoare pentru daune rezultate din utilizarea necorespunzătoare a livrabilelor de către Client, modificări efectuate de terți sau neîntreținerea unor copii de siguranță adecvate.</li>
      </ul>
      ...
      <h2>15. Modificări</h2>
      <p>NovaWorks își rezervă dreptul de a modifica acești Termeni în orice moment. Versiunea actualizată va fi publicată pe site-ul nostru cu o dată revizuită de &quot;Ultima actualizare&quot;.</p>
